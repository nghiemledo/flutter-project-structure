class Constants {
  ...
  /// Api
  static const String baseUrl = "https://example_domain.com";

  /// Users API
  static const String getAllUsersApiUrl = "$baseUrl/api/GetAllUsers";
  static const String getUserApiUrl = "$baseUrl/api/GetUser";
  static const String setUserLastSeenDateTimeApiUrl =
      "$baseUrl/api/UserLastSeenDateTime";
  ...
  static const String getMissedMessagesApiUrl =
      "$baseUrl/api/GetMissedMessages";
  ...
  static const String getAllGroupUsersByPhoneNumberApiUrl =
      "$baseUrl/api/GetAllGroupUsersByPhoneNumber";
  ...
  /// GroupMessages API
  static const String getAllGroupMessagesApiUrl =
      "$baseUrl/api/GetAllGroupMessages";
  static const String removeGroupMessageApiUrl =
      "$baseUrl/api/RemoveGroupMessage";
  static const String getGroupMessageApiUrl = "$baseUrl/api/GetGroupMessage";
  static const String getMissedGroupMessagesApiUrl =
      "$baseUrl/api/GetMissedGroupMessages";
  static const String saveGroupMessageApiUrl = "$baseUrl/api/SaveGroupMessage";
  static const String updateAllGroupMessagesApiUrl =
      "$baseUrl/api/UpdateAllGroupMessage";

  /// GroupMessageTypes API
  static const String getAllGroupMessageTypesApiUrl =
      "$baseUrl/api/GetAllGroupMessageTypes";
  static const String removeGroupMessageTypeApiUrl =
      "$baseUrl/api/RemoveGroupMessageType";
  static const String getGroupMessageTypeApiUrl =
      "$baseUrl/api/GetGroupMessageType";
  static const String saveGroupMessageTypeApiUrl =
      "$baseUrl/api/SaveGroupMessageType";
  static const String updateAllGroupMessageTypesApiUrl =
      "$baseUrl/api/UpdateAllGroupMessageType";
